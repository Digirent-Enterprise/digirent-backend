...
router.post("/refresh-tokens", authenticateToken, (req, res) =>
...
router.post("/forgot-password-request", (req, res) =>
  authController.requestForgetPassword(req, res),
);
router.post(
  "/verify-forgot-password-request",
  authenticateResetPasswordToken,
  (req, res) => authController.verifyForgotPasswordRequest(req, res),
);
router.put(
  "/reset-forgot-password",
  authenticateResetPasswordToken,
  (req, res) => authController.resetForgottenPassword(req, res),
);
